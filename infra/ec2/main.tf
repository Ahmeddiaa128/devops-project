...
output "ssh_connection_string_for_ec2" {
  value = format("%s%s", "ssh -i /home/ubuntu/keys/aws_ec2_terraform ubuntu@", aws_instance.dev_proj_ec2.public_ip)
}

output "dev_proj_ec2_instance_id" {
...
resource "aws_key_pair" "dev_proj_public_key" {
  key_name   = "aws_key"
